...
<span class="input-group-addon">
  ...
  <i class="fas fa-file-alt" aria-hidden="true"></i>
    ...
    <div class="form-control" style="padding: 10px; display: flex; align-items: center;">
...
<span class="input-group-addon">
  <i class="fas fa-puzzle-piece" style="color:rgb(228, 231, 236);"></i>
</span>    <select class="form-control" name="cat" id="cat-select">
        ...
        <option value="universitaire" <?= (isset($product['categorie']) && $product['categorie'] === 'universitaire') ? 'selected' : '' ?>>Universitaire</option>
    </select>
 ...
 document.addEventListener('DOMContentLoaded', function() {
    ...
    form.addEventListener('submit', function(e) {
        ...
        if (descInput.value.trim() === '') {
            ...
            isValid = false;
        } else if (descInput.value.trim().length < 3) {
            showError(descInput, 'La description doit faire au moins 3 caractères');
            isValid = false;
        } else {
