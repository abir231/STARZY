...
echo 'Chemin absolu de Profile.php : ' . realpath(__DIR__ . '/../model/Profile.php');
...
<body>
    ...
    <div class="d-flex justify-content-center gap-3">
            ...
            <a href="http://localhost/projet/" class="btn btn-astronaut" style="background: linear-gradient(135deg, var(--cosmic-pink), var(--deep-purple));">
            <i class="bi bi-stars me-2"></i>Explorer l'Univers
        </a>
