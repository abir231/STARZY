...
<head>
	...
	<title>Chart.js | STARZY Demo</title>
	...
	<div class="wrapper">
		<nav id="sidebar" class="sidebar js-sidebar">
          ...
          <span class="align-middle">STARZY</span>
              ...
              <i class="align-middle" data-feather="square"></i> <span class="align-middle"> produits</span>
            </a>
					</li>

					<li class="sidebar-item">
						<a class="sidebar-link" href="ui-forms.html">
              <i class="align-middle" data-feather="check-square"></i> <span class="align-middle">ressources</span>
            </a>
					</li>

					<li class="sidebar-item">
						<a class="sidebar-link" href="ui-cards.html">
              <i class="align-middle" data-feather="grid"></i> <span class="align-middle">evenements</span>
            </a>
					</li>

					<li class="sidebar-item">
						<a class="sidebar-link" href="ui-typography.html">
              <i class="align-middle" data-feather="align-left"></i> <span class="align-middle"></span>
            </a>
					</li>

					<li class="sidebar-item">
						<a class="sidebar-link" href="icons-feather.html">
              <i class="align-middle" data-feather="coffee"></i> <span class="align-middle">collaboration</span>
            </a>
					</li>
		...
		<div class="main">
          ...
          <i class="hamburger align-self-center"></i>
                ...
                <img src="img/avatars/avatar.jpg" class="avatar img-fluid rounded me-1" alt="Charles Hall" /> <span class="text-white">Charles Hall</span>
              </a>
